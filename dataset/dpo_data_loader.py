"""
=============================================================================
数据加载模块 - DPO训练 (dpo_data_loader.py)
=============================================================================

【模块作用】
实现DPO (Direct Preference Optimization) 的数据加载器

【相关知识】
1. DPO: 直接偏好优化，使用人类偏好数据微调模型
2. chosen vs rejected: 优选回答vs拒绝回答
3. 偏好数据: (prompt, chosen, rejected) 三元组
"""
